    ...
    <div class="col-xs-12">
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                ...
                <li class="active"><a href="index?product_lang_id=<?=$product_lang_id?>"> 保障计划</a></li>
                ...
                <div class="active tab-pane">
                    <div class="box">
                        <div class="box-header">
                            <?= Html::create(['edit?product_lang_id='.$product_lang_id], '新建计划'); ?>
                        </div>
                                ...
                                <table class="table table-bordered table-hover order-column">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>语言</th>
                                            <th>计划名称</th>
                                            <th class="col-md-1">计划类型</th>
                                            <th class="col-md-1">权益数量</th>
                                            ...
                                            <?php foreach($models as $k => $model):?>
                                                ...
                                                <?php foreach($model->langs as $langItem):?>
                                                    <tr data-pid="<?=$model->id?>" data-id="<?=$langItem->id?>">
                                                        ...
                                                        <td><?=$langItem->name?></td>
                                                        <?php if ($isFirst): ?>
                                                            <td rowspan="<?=$langCount?>" style="text-align: center;" class="<?=$model->type == 1 ? 'red' : ''?>">
                                                                <?=ProductPlan::TYPE[LangEnum::CN][$model->type]?>
                                                            </td>
                                                            <td rowspan="<?=$langCount?>" style="text-align: center;">
                                                                <a class="blue" href="../product-plan-right/index?product_lang_id=<?=$product_lang_id?>&product_plan_id=<?=$model->id?>"><?=$model->rightCount?></a>
                                                            </td>
