...
$this->params['breadcrumbs'][] = ['label' => '保障权益', 'url' => ['index?product_lang_id=' . $product_lang_id . '&product_plan_id=' . $product_plan_id]];
    ...
    <div class="col-lg-12">
        <div class="box">
            ...
            <div class="box-body">
                ...
                <?= $form->field($model, 'content')->textarea(['style' => 'height: 100px;']) ?>
            </div>
