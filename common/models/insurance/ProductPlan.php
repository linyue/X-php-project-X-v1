...
/**
 * This is the model class for table "{{%insurance_product_plan}}".
 *
 * @property string $id
 * @property string $product_id
 * @property int $type 计划类型(1:主计划,2:子计划)
 ...
 *
 * @property ProductPlanLang $langs
...
class ProductPlan extends ActiveRecord
{
    ...
    public function getLangs(){
        return $this->hasMany(ProductPlanLang::class, ['pid' => 'id']);
    }
    ...
    public function findByLang($lang){
        return ProductPlanLang::findOne(['pid' => $this->id, 'lang' => $lang]);
    }

    public function getRightCount(){
        return $this->hasMany(ProductPlanRight::class, ['product_plan_id' => 'id'])->andWhere(['status' => 1])->count();
    }
